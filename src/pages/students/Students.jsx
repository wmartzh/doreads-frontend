    ...
    <div className="body">
      ...
      <div className="Cont">
        <div className="DescStudents">
          ...
          <div>
            <h1 className="Title">
              <span>Student Fines:</span> ipsum dolor sit amet consectetur adipisicing elit. Ut
              minima fugiat beatae soluta doloribus. Nostrum impedit obcaecati fugiat laborum vero
              nesciunt minima nisi, voluptatibus ullam hic sint deserunt officia corporis. Lorem
              ipsum dolor sit amet consectetur adipisicing elit. Perferendis ducimus possimus odit
              eos deserunt neque quia, adipisci laudantium accusantium alias earum dolorem expedita
              molestiae voluptas perspiciatis sapiente cum quae fugiat.
            </h1>
          </div>
          <div>
            <h1 className="Title">
              <span>View Student:</span> ipsum dolor sit amet consectetur adipisicing elit. Ut
              minima fugiat beatae soluta doloribus. Nostrum impedit obcaecati fugiat laborum vero
              nesciunt minima nisi, voluptatibus ullam hic sint deserunt officia corporis. Lorem,
              ipsum dolor sit amet consectetur adipisicing elit. Explicabo beatae eius sequi
              doloribus fuga vitae ratione sit, unde repellendus ex excepturi minus, neque
              reiciendis corrupti recusandae, assumenda praesentium odit labore?
            </h1>
          </div>
        </div>
